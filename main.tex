...
% Chapter group entries (part level) — visually distinct from sections
\setlength{\cftbeforepartskip}{12pt}
\setlength{\cftpartindent}{0pt}
\setlength{\cftpartnumwidth}{0pt}
\renewcommand{\cftpartfont}{\large\bfseries\color{ntnublue}}
\renewcommand{\cftpartpagefont}{\large\bfseries\color{ntnublue}}
\renewcommand{\cftpartleader}{\color{ntnublue}\cftdotfill{\cftdotsep}}
...
\newcommand{\chapterdivider}[2]{%
  ...
  \vspace{1cm}
  \markboth{#2}{#2}
  \addtocontents{toc}{\protect\vspace{4pt}\protect\noindent\protect\textcolor{ntnublue}{\protect\rule{\linewidth}{1.5pt}}\par\protect\vspace{-4pt}}
