...
\hypersetup{
  ...
  citecolor=ntnu,
  pdftitle={TTM4100 KTN -- Komplett Studienotat},
  pdfauthor={Markus Selander, NTNU Vår 2026},
}
...
\fancyfoot[L]{\textcolor{black!40}{\small Studienotat -- Vår 2026}}
  ...
  \begin{center}
    \begin{tcolorbox}[
      ...
      {\normalsize\color{white!80} Computer Networking: A Top-Down Approach, 8th ed.\\
       Kurose \& Ross \quad -- \quad NTNU Vår 2026}
    \end{tcolorbox}
  \end{center}
  \vspace{1cm}
  \markboth{#2}{#2}
...
\begin{titlepage}
  ...
  \vspace*{2cm}
  \begin{center}
    {\color{white}\fontsize{16}{20}\selectfont\bfseries TTM4100 -- Kommunikasjon, Tjenester og Nett}\\[0.5em]
    {\color{white!80}\large NTNU -- Norges teknisk-naturvitenskapelige universitet}
  \end{center}

  \vspace{3.5cm}

  \begin{center}
    {\fontsize{40}{48}\selectfont\bfseries\color{ntnublue} Pensumbok}\\[1em]
    {\Large\color{black!70} Kapittel 1 -- 9}\\[2em]
...
%  CHAPTER 1
% ============================================================
\chapterdivider{1}{Kapittel 1: Introduksjon}
\input{chapter1}

% ============================================================
%  CHAPTER 2
% ============================================================
\chapterdivider{2}{Kapittel 2: Applikasjonslaget}
\input{chapter2}

% ============================================================
%  CHAPTER 3
% ============================================================
\chapterdivider{3}{Kapittel 3: Transportlaget}
\input{chapter3}

% ============================================================
%  CHAPTER 4
% ============================================================
\chapterdivider{4}{Kapittel 4: Nettverkslaget -- Dataplanet}
\input{chapter4}
