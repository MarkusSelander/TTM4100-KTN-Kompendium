...
\begin{tikzpicture}[
    ...
    \node[flowstep, fill=orange!15] (s1) at (-3,4) {Opprett socket\\(AF\_INET, SOCK\_DGRAM)};
    \node[flowstep, fill=orange!15] (s2) at (-3,2.8) {bind() til port};
    \node[flowstep, fill=orange!15] (s3) at (-3,1.5) {recvfrom() -- les datagram};
    \node[flowstep, fill=orange!15] (s4) at (-3,0.2) {sendto() -- svar med\\klientadresse};
    ...
    \node[flowstep, fill=green!15] (c1) at (3,4) {Opprett socket\\(AF\_INET, SOCK\_DGRAM)};
    \node[flowstep, fill=green!15] (c2) at (3,2.8) {sendto() -- send med\\server IP + port};
    \node[flowstep, fill=green!15] (c3) at (3,1.5) {recvfrom() -- les svar};
...
\begin{tikzpicture}[
    ...
    \node[flowstep, fill=orange!15] (s1) at (-3,5.7) {Opprett socket\\(AF\_INET, SOCK\_STREAM)};
    \node[flowstep, fill=orange!15] (s2) at (-3,4.5) {bind() + listen()};
    \node[flowstep, fill=orange!15] (s3) at (-3,3.3) {connectionSocket =\\accept()};
    \node[flowstep, fill=orange!15] (s4) at (-3,2) {recv() -- les data};
    \node[flowstep, fill=orange!15] (s5) at (-3,0.8) {send() -- send svar};
    ...
    \node[flowstep, fill=green!15] (c1) at (3,5.7) {Opprett socket\\(AF\_INET, SOCK\_STREAM)};
    \node[flowstep, fill=green!15] (c2) at (3,4.5) {connect() til server\\IP + port};
    \node[flowstep, fill=green!15] (c3) at (3,3.3) {send() -- send data};
    \node[flowstep, fill=green!15] (c4) at (3,2) {recv() -- les svar};
